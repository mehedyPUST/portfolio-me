...
export const profile = {
  ...
  intro:
    "I am an analytical MERN Stack Developer with a strong foundation in Physics, dedicated to building responsive, high-performance web applications and clean user interfaces.",
  photo: mehedyPortfolioImage,
  resumeUrl: "#",
  about: [
...
export const socialLinks = [
  { label: "GitHub", href: "https://github.com/" }, // আপনার প্রোফাইল লিঙ্ক বসাতে পারেন
  { label: "LinkedIn", href: "https://linkedin.com/" }, // আপনার প্রোফাইল লিঙ্ক বসাতে পারেন
  { label: "Twitter", href: "/" },
  { label: "Facebook", href: "/" },
];
